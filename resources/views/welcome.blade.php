...
<head>
    ...
    <!-- Site Properties -->
    <title>Selisha - Hotel &amp; Resort</title>
                                            ...
                                            @if (Route::has('login'))
                                                @auth
                                                    <a href="{{ url('/dashboard') }}"
                                                        class="uk-navbar-nav-subtitle">Dashboard</a>
                                                @else
                                                    <a href="{{ route('login') }}" class="uk-navbar-nav-subtitle">
                                                        <div>Log In
                                                        </div>
                                                    </a>
                                                @endauth
                ...
                <div class="uk-width-2-3@xl uk-width-2-3@l uk-width-1-1@m uk-width-1-1@s">
                    <div class="impx-intro uk-text-center uk-light uk-margin-remove-bottom">
                        <h2 class="uk-margin-remove-vertical uk-margin-remove-bottom">Choose the Best Rooms &amp; Make
                            Reservation </h2>
                        <p class="impx-text-large uk-margin-remove-bottom uk-margin-small-top">Etenim semper illud
                            extra arte comprehenditur utebare non numquam.</p>
                    </div>
                </div>
            </div>
            <!-- Intro Text End -->
            ...
            <div class="uk-container">
                ...
                <div data-uk-grid class="uk-padding-remove-bottom"><!-- Address -->
                    <div class="uk-light uk-width-1-2@xl uk-width-1-2@l uk-width-1-2@m uk-width-1-1@s">
                        ...
                        <p class="impx-text-large uk-margin-top impx-text-light">Jln. Raya Kemerderkaan RI No.
                    ...
                    <div class="uk-light uk-width-1-4@xl uk-width-1-4@l uk-width-1-4@m uk-width-1-1@s"><!-- Phone -->
                        ...
                        <p class="impx-text-large uk-margin-remove impx-text-light">+62 123456789<br />+62 987456123
                        </p>
                    </div><!-- Phone End -->
                ...
                <div class="uk-width-1-2@xl uk-width-1-2@l uk-width-2-3@m">
                    <div class="impx-footer-logo uk-align-center uk-text-center">
                        ...
                        <p class="uk-margin-bottom">Erit enim mecum, si tecum erit. Re mihi non aeque satisfacit, et
                            ...
                            postulet.</p>
                        <!-- Site Copyright -->
                        <p class="impx-copyright"><a target="_blank" href="https://www.templateshub.net">Templates
                                Hub</a></p>
                    </div>
                </div>
            </div>
